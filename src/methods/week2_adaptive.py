...
def week2_adaptive(video: Video, alpha=1.75, rho=0.4, debug=False, disable_tqdm=False) -> Iterator[Frame]:
    ...
    for im, mask in gaussian_model_adaptive(video, int(2141 * 0.25), model_mean, model_std, alpha=alpha, rho=rho,

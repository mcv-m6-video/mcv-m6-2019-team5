...
def main():
    ...
    writer.add_embedding(train_embeddings, label_img=torch.tensor(train_targets), tag='Train embeddings')

    if test_loader is not None:
        test_embeddings, test_targets = extract_embeddings(test_loader, model, cuda)
        writer.add_embedding(test_embeddings, label_img=torch.tensor(test_targets), tag='Test embeddings')
